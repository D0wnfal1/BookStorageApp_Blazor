...
public partial class BookStoreDbContext : IdentityDbContext<ApiUser>
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		{
			entity.HasKey(e => e.Id).HasName("PK__Authors__3214EC07E57DB558");
		...
		{
			entity.HasKey(e => e.Id).HasName("PK__Books__3214EC07499374AC");

			entity.HasIndex(e => e.Isbn, "UQ__Books__447D36EAE9F4EFDD").IsUnique();
